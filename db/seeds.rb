...
workout8 = Workout.create(user_id: uzoma.id, exercise_id: bench_press.id, date: "2020-03-26")
workout9 = Workout.create(user_id: samantha.id, exercise_id: hiking.id, date: "2020-03-22")
workout10 = Workout.create(user_id: matt.id, exercise_id: crunches.id, date: "2020-03-23")
workout11 = Workout.create(user_id: chuck.id, exercise_id: squats.id, date: "2020-03-21")
workout12 = Workout.create(user_id: arnold.id, exercise_id: plank.id, date: "2020-03-12")
workout13 = Workout.create(user_id: wendy.id, exercise_id: bicep_curls.id, date: "2020-03-13")
workout14 = Workout.create(user_id: chine.id, exercise_id: lunges.id, date: "2020-03-14")
workout15 = Workout.create(user_id: beza.id, exercise_id: lunges.id, date: "2020-03-22")
workout16 = Workout.create(user_id: bret.id, exercise_id: bench_press.id, date: "2020-03-23")
workout17 = Workout.create(user_id: lindsay.id, exercise_id: crunches.id, date: "2020-03-12")
workout18 = Workout.create(user_id: danny.id, exercise_id: plank.id, date: "2020-03-10")
workout19 = Workout.create(user_id: carla.id, exercise_id: hiking.id, date: "2020-03-13")
workout20 = Workout.create(user_id: richard.id, exercise_id: squats.id, date: "2020-03-24")
workout21 = Workout.create(user_id: mary.id, exercise_id: bicep_curls.id, date: "2020-03-26")
workout22 = Workout.create(user_id: michael.id, exercise_id: squats.id, date: "2020-03-26")
workout23 = Workout.create(user_id: deijah.id, exercise_id: bench_press.id, date: "2020-03-23")
workout24 = Workout.create(user_id: tomazye.id, exercise_id: bench_press.id, date: "2020-03-02")
workout25 = Workout.create(user_id: sebastian.id, exercise_id: squats.id, date: "2020-03-02")
workout26 = Workout.create(user_id: junior.id, exercise_id: squats.id, date: "2020-03-12")
workout27 = Workout.create(user_id: alex.id, exercise_id: squats.id, date: "2020-03-26")
workout28 = Workout.create(user_id: ann.id, exercise_id: squats.id, date: "2020-03-26")
workout29 = Workout.create(user_id: uzoma.id, exercise_id: squats.id, date: "2020-03-26")
workout30 = Workout.create(user_id: yari.id, exercise_id: squats.id, date: "2020-03-14")
