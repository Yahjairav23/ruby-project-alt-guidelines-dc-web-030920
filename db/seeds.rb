...
workout2 = Workout.create(user_id: chine.id, exercise_id: bicep_curls.id, date: "2020-03-20", gym_id: gym2.id)
...
workout7 = Workout.create(user_id: chine.id, exercise_id: squats.id, date: "2020-03-20", gym_id: gym7.id)
workout8 = Workout.create(user_id: chine.id, exercise_id: bench_press.id, date: "2020-03-26", gym_id: gym8.id)
...
workout29 = Workout.create(user_id: chine.id, exercise_id: squats.id, date: "2020-03-26", gym_id: gym9.id)
